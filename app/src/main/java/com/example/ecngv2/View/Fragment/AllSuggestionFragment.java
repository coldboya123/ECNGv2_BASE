...
public class AllSuggestionFragment extends Fragment {
    ...
    private void loadData(List<Product> list_products){
        list_products.add(new Product(R.drawable.laptop, 999, "Laptop DELL inpresion ZT125 ECNG ZT125 ECNG ZT125 ECNG", 20000000, (float) 4.5));
        list_products.add(new Product(R.drawable.dongho, 99, "Laptop DELL inpresion ZT125 ECNG.ZT125 ECNG ZT125 ECNG", 20000000, (float) 4.5));
        ...
        list_products.add(new Product(R.drawable.cate_thoitrang, 999, "Laptop DELL inprsion ZT125 ECNG...", 20000000, (float) 5));
        list_products.add(new Product(R.drawable.cate_thucpham, 999, "Laptop DELL inprsion ZT125 ECNG...", 20000000, (float) 5));
        ...
        list_products.add(new Product(R.drawable.cate_dongho, 999, "Laptop DELL inpresion ZT125 ECNG...", 20000000, (float) 5));
